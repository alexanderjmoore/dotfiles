...
hl.bind(mainMod .. " + SHIFT + 3", moveWindow({ monitor = MONITOR3 }))
hl.bind(mainMod .. " + SHIFT + mouse_up", moveWindow({ monitor = "-1" }))
hl.bind(mainMod .. " + SHIFT + mouse_down", moveWindow({ monitor = "+1" }))
hl.bind(mainMod .. " + CONTROL + SHIFT + Up", moveWindow({ monitor = "u" }))
hl.bind(mainMod .. " + CONTROL + SHIFT + Right", moveWindow({ monitor = "r" }))
hl.bind(mainMod .. " + CONTROL + SHIFT + Left", moveWindow({ monitor = "l" }))
hl.bind(mainMod .. " + CONTROL + SHIFT + Down", moveWindow({ monitor = "d" }))
hl.bind(mainMod .. " + CONTROL + SHIFT + mouse_up", moveWindow({ workspace = "m-1" }))
hl.bind(mainMod .. " + CONTROL + SHIFT + mouse_down", moveWindow({ workspace = "m+1" }))

for i = 1, NUM_WPM do
	local key = i % 10
	hl.bind(mainMod .. " + SHIFT + CONTROL + " .. key, moveWindow({ workspace = "m~" .. i }))
end
